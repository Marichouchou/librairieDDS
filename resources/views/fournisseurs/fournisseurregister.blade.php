...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Selection_fournisseurs') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route(fournisseur.create') }}">
                        ...
                        <div class="row mb-3">
                            <label for="nbre_livres" class="col-md-4 col-form-label text-md-end">{{ __('Nbre_livres') }}</label>

                            <div class="col-md-6">
                                <input id="nbre_livres" type="number" class="form-control @error('nbre_livres') is-invalid @enderror" name="nbre_livres" value="{{ old('nbre_livres') }}" required autocomplete="nbre_livres" autofocus>
